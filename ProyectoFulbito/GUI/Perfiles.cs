    ...
    public partial class PerfilesForm : Form, ITraducible
    {
        ...
        private void btnCrear_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ActualizarPerfiles();
                LogBitacora.AgregarEvento("Crear perfil", 3, SessionManager.getInstance.usuario);
            }
            catch (Exception ex)
            {
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            ActualizarPerfiles();
            HabilitarControl();
            LogBitacora.AgregarEvento("Borrar perfil", 3, SessionManager.getInstance.usuario);
        }
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            actualizarTree();
            HabilitarControl();
            LogBitacora.AgregarEvento("Agregar permisos al perfil", 3, SessionManager.getInstance.usuario);
        }
        ...
        private void btnCerrar_Click(object sender, EventArgs e)
        {
            ...
            LogBitacora.AgregarEvento("Salir del form Perfiles", 1, SessionManager.getInstance.usuario);
        }
        ...
        private void btnModificarperfil_Click(object sender, EventArgs e)
        {
            ...
            if (resultado == DialogResult.Yes)
            {
                ...
                LogBitacora.AgregarEvento("Modificar perfil actual", 3, SessionManager.getInstance.usuario);
                ActualizarPerfiles();
            }
        }
    }
