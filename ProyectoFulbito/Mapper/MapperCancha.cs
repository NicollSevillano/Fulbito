...
namespace Mapper
{
    public class MapperCancha : IABMC<BeCancha>
    {
        ...
        public void CambiarEstado(BeCancha pObject)
        {
            string sp_CE_Cancha = "sp_Cambiar_Estado_Cancha";
            arraylist = new ArrayList();
            ...
            dao.Escribir(sp_CE_Cancha, arraylist);
        }
        ...
        public void Modificacion(BeCancha pObject)
        {
            ...
            SqlParameter p4 = new SqlParameter();
            p4.ParameterName = "@Capacidad";
            p4.Value = pObject.Capacidad;
